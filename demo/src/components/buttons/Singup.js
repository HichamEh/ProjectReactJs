...
const SingUp = () =>{
    return(
        <>
        <button type="button" className="btn btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#singupModal">
        ...
        <div className="modal-dialog">
            <div className="modal-content">
                ...
                <div className="modal-body">
                    ...
                    <form>
                        <div className="mb-3">
                            <label for="exampleInput" className="form-label">Email address</label>
