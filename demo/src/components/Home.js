...
const Home = () =>{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/assets/images/Home/img1.webp" class="d-block w-100" alt="Iphone" height='500px'/>
    </div>
    <div class="carousel-item">
      <img src="/assets/images/Home/img2.jpg" class="d-block w-100" alt="Iphone" height='500px'/>
    </div>
    <div class="carousel-item">
      <img src="/assets/images/Home/img3.png" class="d-block w-100" alt="Iphone" height='500px'/>
    </div>
  </div>
